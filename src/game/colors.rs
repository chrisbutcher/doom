...
pub fn load_first_palette(wad_file: &[u8], lumps: &[lumps::Lump]) -> Vec<wad_graphics::PaletteColor> {
...
pub fn load_first_colormap(wad_file: &[u8], lumps: &[lumps::Lump]) -> wad_graphics::Colormap {
