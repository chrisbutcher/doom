...
pub struct Map {
    pub name: String,
    pub vertexes: Vec<MapVertex>,
    pub linedefs: Vec<LineDef>,
    pub sidedefs: Vec<SideDef>,
    pub sectors: Vec<Sector>,
    pub map_centerer: map_svg::MapCenterer,
}
...
pub struct LineDef {
    ...
    pub back_sidedef_index: Option<usize>,
}
...
pub struct SideDef {
    ...
    pub name_of_lower_texture: Option<String>,
    pub name_of_middle_texture: Option<String>, // NOTE: Most normal walls only have this on their front side
    pub sector_facing: usize, // ... but some walls like the grates at the end of e1m1 have only a middle on both sides
}
...
pub struct Sector {
    ...
    pub name_of_ceiling_texture: String, // Make these Option<String> ?
    pub light_level: i16,
    pub sector_type: i16,
    pub tag_number: i16,
}
...
pub fn load(map_name_pattern: &str, wad_file: &[u8], lumps: &[lumps::Lump]) -> Map {
        ...
        if current_map_name.is_some() {
            if lump.name == "VERTEXES" {
                ...
                for _ in 0..vertex_count {
                    ...
                    current_map_vertexes.push(MapVertex { x, y });
            ...
            if lump.name == "SIDEDEFS" {
                ...
                for sidedef_index in 0..sidedef_count {
                    ...
                    current_map_sidedefs.push(SideDef {
                        ...
                        x_offset,
                        y_offset,
                        name_of_upper_texture, // TODO, sometimes return None, if texture is blank
                        name_of_lower_texture,
                        name_of_middle_texture,
                        sector_facing,
                    });
            ...
            if lump.name == "SECTORS" {
                ...
                for sector_index in 0..sector_count {
                    ...
                    current_map_sectors.push(Sector {
                        ...
                        floor_height,
                        ceiling_height,
                        name_of_floor_texture,
                        name_of_ceiling_texture,
                        light_level,
                        sector_type,
                        tag_number,
                    });
